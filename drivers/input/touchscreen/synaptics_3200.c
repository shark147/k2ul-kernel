 ...
 *
 * Sweep2wake and Doubletap2wake for HTC One SV is ported from: HTC ONE
...
static int s2w_switch = 0; // 0=disabled, 1=sweep2wake+sweep2sleep, 2=sweep2sleep only
static int dt2w_switch = 2; // 0=disabled, 1&2=doubletap2wake
